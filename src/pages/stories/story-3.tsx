  ...
  return (
    <div className="min-h-screen bg-background pt-16">
      <div className="container mx-auto px-4 max-w-5xl">
        ...
        {/* Title */}
        <h1 className="text-4xl font-bold mb-6 max-w-3xl">
          Armadale Cellars top wine picks for 2025!
        </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="story-card bg-white rounded-lg shadow-md overflow-hidden transition-transform hover:shadow-lg hover:-translate-y-1 duration-300 flex flex-col h-full">
              ...
              <div className="p-6 flex-1 flex flex-col">
                <h3 className="text-xl font-bold text-foreground line-clamp-2 h-14 mb-2">
                  Cru Beaujolais 2021 Vintage: Last stock!
                </h3>
                ...
                <div className="mt-auto">
                  <button className="inline-flex items-center justify-center gap-2 whitespace-nowrap ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 h-10 bg-[#080d1e] hover:bg-[#080d1e]/90 rounded-none uppercase px-8 py-2 text-sm font-medium w-full text-white">
                    Claim
                  </button>
                </div>
              </div>
